...
const AdminDashboard = () => {
    ...
    const handleUpload4 = async () => {
        // Implement your upload logic for the second image
        if (selectedFile4 && productItemTitle) {
            const formData = new FormData();
            ...
            try {
                ...
                console.log('Product dataUpload successfully :', response.data);
                // Custom logic after uploading the second image
            ...
            console.error('Missing required fields: image, title, or description');
        }
    };
                    ...
                    <div className="flex-1 bg-gray-100 p-10 pb-48">
                        ...
                        <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
                            ...
                            <div className="bg-white p-6 shadow-md rounded-lg">
                                ...
                                <div className=''>
                                    <button
                                        className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mx-4 rounded inline-flex"
                            ...
                            <div className="bg-white p-6 shadow-md rounded-lg">
                                ...
                                <div className=" flex items-center mb-4">
                                    <label htmlFor='title' className="cursor-pointer text-black font-bold py-2 px-4">
                                        Add Title :
                                    </label>
                                    <input
                                        type="text"
                            ...
                            <div className='bg-white p-6 shadow-md rounded-lg'>
                                ...
                                <div className=''>
                                    <button
                                        className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mx-4 rounded inline-flex mb-8"
                            ...
                            <div className='bg-white p-6 shadow-md rounded-lg'>
                                ...
                                <div className=" flex items-center mb-4">
                                    <label htmlFor='Description' className="cursor-pointer text-black font-bold py-2 px-4">
                                        Add Description :
                                    </label>
                                    <textarea
                                ...
                                <div className=" flex items-center mb-4">
                                    <label htmlFor='productItem' className="cursor-pointer text-black font-bold py-2 px-4">
                                        Add Item :
                                    </label>
                                    <div className="hs-dropdown relative inline-flex  mx-4">
                                        <select id="productItem" onChange={(e)=> console.log(e.target.value)} >
                                         <option disabled>Select Item</option>
                                         {productOptions.map((option, index)=>(<option key={index} value={option}>{option}
                                         </option>
                                         ))}
                                        </select>
                                    </div>
